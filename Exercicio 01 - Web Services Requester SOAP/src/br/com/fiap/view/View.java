		...
		while (!opcaoCliente.equals("SAIR")) {
			...
			case "ATUALIZAR":
				...
				JOptionPane.showConfirmDialog(null,
						"Data de Nascimento: " + cliente.getDataNascimento().getTime().toString());
			...
			case "ENCONTRAR":
				...
				JOptionPane.showConfirmDialog(null,
						"Data nascimento: " + cliente.getDataNascimento().getTime().toString());
				break;
			...
			case "DELETAR":
				...
				if (JOptionPane.showConfirmDialog(null,
						"Nome: " + cliente.getNome() + "\nEmail: " + cliente.getEmail() + "\nData Nascimento:  "
								+ cliente.getDataNascimento().getTime().toString() + "\nDeletar?",
						"DELETAR", JOptionPane.YES_NO_OPTION) == 0) {
					removeParams.setId(cliente.getCodigo());
